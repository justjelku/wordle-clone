...
import type { GameState, TileState } from "api/lib/schema";
...
export function useGameState(
  ...
  const updateTiles = useCallback(
    (guesses: string[], currentGuess: string, currentRow: number) => {
  ...
  const handleEnter = useCallback(async () => {
    ...
    try {
      const validation = await validateWordMutation.mutateAsync(
      ...
      const won =
        gameState.currentGuess.toUpperCase() === targetWord.toUpperCase();
